...
export default async function BookingsPage() {
  ...
  const serialized = bookings.map((b) => ({
    ...
    hasPet: b.hasPet,
    laundryPackages: b.laundryPackages,
    ...
    invoice: b.invoice
      ? {
          ...
          reminderLevel: b.invoice.reminderLevel,
          nextReminderDueAt: b.invoice.nextReminderDueAt?.toISOString() ?? null,
          lastReminderSentAt: b.invoice.lastReminderSentAt?.toISOString() ?? null,
